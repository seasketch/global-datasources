...
INSERT INTO eez_with_land_final (geom, "UNION")
SELECT
  geom,
  "UNION"
FROM (
...
WITH complex_areas_to_subdivide AS (
    DELETE FROM eez_with_land_final
...
CREATE INDEX ON eez_with_land_final USING gist(geom);
