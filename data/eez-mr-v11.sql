...
INSERT INTO eez_mr_v11_final (geom, "GEONAME")
SELECT
  geom,
  "GEONAME"
FROM (
...
WITH complex_areas_to_subdivide AS (
    DELETE FROM eez_mr_v11_final
    WHERE ST_NPoints(geom) > 256
    returning gid, geom, "GEONAME"
)
...
CREATE INDEX ON eez_mr_v11_final USING gist(geom);
