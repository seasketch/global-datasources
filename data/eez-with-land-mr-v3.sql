...
INSERT INTO eez_with_land_mr_v3_final (geom, "UNION")
SELECT
  geom,
  "UNION"
FROM (
...
) AS eez_with_land_mr_v3_final;

-- Unioning of subdivided EEZ boundaries currently produces errors in some test cases so use this method at your own risk
-- subdivide only features over 512 points by deleting and re-inserting new

WITH complex_areas_to_subdivide AS (
    DELETE FROM eez_with_land_mr_v3_final
...
CREATE INDEX ON eez_with_land_mr_v3_final USING gist(geom);
